...
def routing_masked(input_tensor, seq_length, hidden_size, out_caps_num=5, iter=3, dropout=0.1,
                  scope=None):
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    sent_rep = routing_masked(output_layer, seq_length,hidden_size, 2, 3, 0.1, scope='attention')
